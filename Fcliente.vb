...
Public Class Fcliente
    ...
    Public Function ingresa_cliente(cod As String, nom As String, ape As String, rf As String, sex As String, dir As String, tel As String) As Boolean
        conectado()
        ...
        cmd.Parameters.AddWithValue("@rfc", rf)
    ...
    Public Function edita_cliente(cod As String, nom As String, ape As String, rf As String, sex As String, dir As String, tel As String) As Boolean
        conectado()
